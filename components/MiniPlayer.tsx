...
// MiniPlayer vive fuera del segmento [locale] (para no desmontarse al
// cambiar de idioma), así que no puede usar useTranslations — arma sus
// propios textos a partir del idioma detectado en la URL.
const dict = {
  es: {
    region: "Reproductor",
    nowPlaying: (station: string) => `Sonando ahora — ${station}`,
    loadingNext: "Cargando siguiente pista…",
    pause: "Pausar",
    play: "Reproducir",
  ...
  en: {
    region: "Player",
    nowPlaying: (station: string) => `Now playing — ${station}`,
    loadingNext: "Loading next track…",
    pause: "Pause",
    play: "Play",
